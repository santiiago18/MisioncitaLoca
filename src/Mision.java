public class Mision {
    ...
    /**
     * Texto de todos los atributos de la clase Mision
     * @return texto con todos los atributos de la clase Mision
     */
    public String toString(){
        String resultado;

        resultado = String.format(new String("Mision: id: %d, nombre: %s, dificultas: %d, nivel recomendad: %d,            recompensa experiencia: %d, completada: %b"),
